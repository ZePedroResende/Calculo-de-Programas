...
\\
\>[B]{}\mathbf{import}\;\Conid{\Conid{Data}.Either}{}\<[E]%
\ColumnHook
...
\column{31}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inv}\;\Varid{x}\mathrel{=}\p2\comp (\mathsf{for}\ \conj{((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\comp \p1}{\uncurry{(\mathbin{+})}\comp (((\mathrm{1}\mathbin{-}\Varid{x})\mathbin{*})\times\Varid{id})}\ (\mathrm{1},\mathrm{1})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 inv}\;\Varid{x}\mathrel{=}(\Varid{x}\mathbin{>}\mathrm{1}\mathrel{\wedge}\Varid{x}\mathbin{<}\mathrm{2})\mathbin{==>}\Varid{abs}\;((\Varid{inv}\;(\Varid{inv}\;\Varid{x}\;\mathrm{5000})\;\mathrm{5000})\mathbin{-}\Varid{x})\mathbin{<}\Varid{diferenca}{}\<[E]%
\\
\>[B]{}\hsindent{31}{}\<[31]%
\>[31]{}\mathbf{where}\;\Varid{diferenca}\mathrel{=}\mathrm{0.000000009}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{worker}\mathrel{=}\Varid{cataList}\;\alt{\conj{\Varid{true}}{\underline{\mathrm{0}}}}{\conj{\Varid{sep}\comp \p1}{\mcond{(\uncurry{(\mathrel{\wedge})}\comp ((\neg \comp \Varid{sep})\times(\p1)))}{{}\<[111]%
\>[111]{}(\succ \comp \p2\comp \p2)}{(\p2\comp \p2)}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{sep}\;\Varid{c}\mathrel{=}{}\<[14]%
\>[14]{}\Varid{c}\equiv \text{\tt '~'}\mathrel{\vee}\Varid{c}{}\<[29]%
\>[29]{}\equiv \text{\tt '\char92 n'}\mathrel{\vee}\Varid{c}\equiv \text{\tt '\char92 t'}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{genSafeChar}\mathbin{::}\Conid{Gen}\;\Conid{Char}{}\<[E]%
\\
\>[B]{}\Varid{genSafeChar}\mathrel{=}\Varid{elements}\;([\mskip1.5mu \text{\tt 'a'}\mathinner{\ldotp\ldotp}\text{\tt 'z'}\mskip1.5mu]\plus \text{\tt \char34 ~\char92 n\char92 t\char34}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genSafeString}\mathbin{::}\Conid{Gen}\;\Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{genSafeString}\mathrel{=}\Varid{listOf}\;\Varid{genSafeChar}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{newtype}\;\Conid{SafeString}\mathrel{=}\Conid{SafeString}\;\{\mskip1.5mu \Varid{unwrapSafeString}\mathbin{::}\Conid{String}\mskip1.5mu\}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{deriving}\;\Conid{Show}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 wc\char95 w\char95 final}\mathrel{=}\Varid{forAll}\;\Varid{genSafeString}\mathbin{\$}\lambda \Varid{str}\to (\Varid{wc\char95 w\char95 final}\;\Varid{str})\equiv (\length \mathbin{\$}\Varid{words}\;\Varid{str}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Consulta de:
...
\\
\>[B]{}\Varid{outB\char95 tree}\;(\Conid{Block}\;\Varid{t}\;\Varid{l})\mathrel{=}i_2\;(\Varid{t},\Varid{l}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inB\char95 tree}{}\<[11]%
\>[11]{}\mathbin{::}()+(\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a},[\mskip1.5mu (\Varid{a},\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\mskip1.5mu])\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{inB\char95 tree}\mathrel{=}\alt{\underline{\Conid{Nil}}}{\uncurry{\Conid{Block}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseB\char95 tree}\mathbin{::}(\Varid{a}\to \Varid{b})\to (\Varid{c}\to \Varid{d})\to ()+(\Varid{c},[\mskip1.5mu (\Varid{a},\Varid{c})\mskip1.5mu])\to ()+(\Varid{d},[\mskip1.5mu (\Varid{b},\Varid{d})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{baseB\char95 tree}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{g}\times(\map \;(\Varid{f}\times\Varid{g}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recB\char95 tree}\mathbin{::}{}\<[15]%
\>[15]{}(\Varid{a}\to \Varid{b})\to ()+(\Varid{a},[\mskip1.5mu (\Varid{d},\Varid{a})\mskip1.5mu])\to ()+(\Varid{b},[\mskip1.5mu (\Varid{d},\Varid{b})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{recB\char95 tree}\;\Varid{g}\mathrel{=}\Varid{baseB\char95 tree}\;\Varid{id}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataB\char95 tree}\mathbin{::}((()+(\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]))\to \Varid{b})\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to \Varid{b}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{anaB\char95 tree}\mathbin{::}(\Varid{a}\to ()+(\Varid{a},[\mskip1.5mu (\Varid{b},\Varid{a})\mskip1.5mu]))\to \Varid{a}\to \mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{b}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloB\char95 tree}\mathbin{::}((()+(\Varid{c},[\mskip1.5mu (\Varid{b},\Varid{c})\mskip1.5mu]))\to \Varid{c})\to (\Varid{a}\to ()+(\Varid{a},[\mskip1.5mu (\Varid{b},\Varid{a})\mskip1.5mu]))\to \Varid{a}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{hyloB\char95 tree}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{h}\comp \Varid{anaB\char95 tree}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=3cm{
\hfill \break
    \ensuremath{\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{outB\char95 tree}}}
           \ar[r]_-{\ensuremath{\cata{\Varid{g}}\mathrel{=}\Varid{inordB\char95 tree}}}
&
    \ensuremath{\Conid{L}}
\\
    \ensuremath{\mathrm{1}\mathbin{+}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\times(\Varid{a}\times\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\;\textsuperscript{*}}
           \ar[r]^-{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{g}}\times\map \;(\Varid{id}\times\cata{\Varid{g}})}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{L}\times(\Varid{a}\times\Conid{L})\;\textsuperscript{*}}
           \ar[u]^-{\ensuremath{\Varid{g}}}
}
...
\\
\>[B]{}\Varid{inordB\char95 tree}\mathrel{=}\Varid{cataB\char95 tree}\;\Varid{inordB\char95 tree\char95 gene}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inordB\char95 tree\char95 gene}\mathbin{::}()+([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu (\Varid{a},[\mskip1.5mu \Varid{a}\mskip1.5mu])\mskip1.5mu])\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{inordB\char95 tree\char95 gene}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}\comp (\Varid{id}\times(\Varid{concat}\comp (\map \;\Varid{cons})))}{}\<[E]%
\\[\blanklineskip]%
...
\hfill \break
    \ensuremath{\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}}
           \ar[d]_-{\ensuremath{\Varid{outB\char95 tree}}}
           \ar[r]_-{\ensuremath{\cata{\Varid{g}}\mathrel{=}\Varid{largestBlock}}}
&
...
\\
    \ensuremath{\mathrm{1}\mathbin{+}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\times(\Varid{a}\times\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a})\;\textsuperscript{*}}
           \ar[r]^-{\ensuremath{\Varid{id}\mathbin{+}\cata{\Varid{g}}\times\map \;(\Varid{id}\times\cata{\Varid{g}})}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\mathbb{N}_0\times(\Varid{a}\times\mathbb{N}_0)\;\textsuperscript{*}}
           \ar[u]^-{\ensuremath{\Varid{g}}}
}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{largestBlock}\mathbin{::}\mathsf{B}\mbox{-}\mathsf{tree} \;\Varid{a}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{largestBlock}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\underline{\mathrm{0}}}{\uncurry{\Varid{max}}\comp (\Varid{id}\times(\uncurry{\Varid{max}}\comp \conj{\length }{\Varid{maximum}\comp (\map \;\p2)}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment (4)------------------------------------------------------------}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{mirrorB\char95 tree}\mathrel{=}\Varid{anaB\char95 tree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;{}\<[13]%
\>[13]{}\Varid{g}\mathrel{=}(\Varid{id}+(\Varid{toTuple}\comp \Varid{reverse}\comp \Varid{toEither}))\comp \Varid{outB\char95 tree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{toTuple}\mathbin{::}[\mskip1.5mu \Varid{a}+\Varid{b}\mskip1.5mu]\to (\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{toTuple}\mathrel{=}\conj{\Varid{head}\comp \p2}{\uncurry{\Varid{zip}}\comp (\Varid{id}\times\Varid{tail})}\comp \Varid{partitionEithers}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{toEither}\mathbin{::}(\Varid{b},[\mskip1.5mu (\Varid{a},\Varid{b})\mskip1.5mu])\to [\mskip1.5mu \Varid{a}+\Varid{b}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{toEither}\mathrel{=}\Varid{cons}\comp (i_2\times(\Varid{concat}\comp \map \;\Varid{listTuple})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{listTuple}\mathbin{::}(\Varid{a},\Varid{b})\to [\mskip1.5mu \Varid{a}+\Varid{b}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{listTuple}\mathrel{=}\Varid{cons}\comp (i_1\times(\Varid{cons}\comp \conj{i_2}{\underline{[\mskip1.5mu \mskip1.5mu]}})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment (5)------------------------------------------------------------}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{qSortB\char95 tree}\mathrel{=}\Varid{hyloB\char95 tree}\;\Varid{inordB\char95 tree\char95 gene}\;\Varid{lsplitB\char95 tree}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{lsplitB\char95 tree}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{l},[\mskip1.5mu (\Varid{h},\Varid{r})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;(\Varid{l},\Varid{r})\mathrel{=}\Varid{mypart}\;(\mathbin{<}\Varid{h})\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\hfill \break
    \ensuremath{\Conid{L}}
           ...
           \ar[r]_-{\ensuremath{\cata{\Varid{g}}\mathrel{=}\Varid{mypart}\;\Varid{p}}}
&
    \ensuremath{(\Conid{L1})\;\textsuperscript{*}\times(\Conid{L2})\;\textsuperscript{*}}
\\
    \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\times\Conid{L}}
           \ar[r]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\cata{\Varid{g}})}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Varid{a}\times((\Conid{L1})\;\textsuperscript{*}\times(\Conid{L2})\;\textsuperscript{*})}
           \ar[u]^-{\ensuremath{\Varid{g}}}
}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mypart}\mathbin{::}(\Varid{a}\to \Conid{Bool})\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{mypart}\;\Varid{p}\mathrel{=}\Varid{cataList}\;\alt{\conj{\Varid{nil}}{\Varid{nil}}}{\mcond{(\Varid{p}\comp \p1)}{\Varid{toFST}}{\Varid{toSND}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{toFST}\mathbin{::}(\Varid{a},([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]))\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{toFST}\mathrel{=}\conj{\Varid{cons}\comp (\Varid{id}\times\p1)}{\p2\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{toSND}\mathbin{::}(\Varid{a},([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]))\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{toSND}\mathrel{=}\conj{\p1\comp \p2}{\Varid{cons}\comp (\Varid{id}\times\p2)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment (6)------------------------------------------------------------}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cB\char95 tree2Exp}\mathrel{=}\Varid{cataB\char95 tree}\;\alt{\underline{\cdot }\mathbin{\$}\Conid{Var}\;\text{\tt \char34 nil\char34}}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{aux}\mathrel{=}\uncurry{\Conid{Term}}\comp \conj{(\map \;\p1)\comp \p2}{\Varid{cons}\comp (\Varid{id}\times((\map \;\p2)))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\Varid{showAlgae}\mathrel{=}\cata{\alt{\underline{\text{\tt \char34 A\char34}}}{\mathsf{conc}\comp \Varid{id}}~\alt{\underline{\text{\tt \char34 B\char34}}}{\Varid{id}}}_A{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prop\char95 Algae}\mathbin{::}\Conid{Int}\to \Conid{Property}{}\<[E]%
\\
\>[B]{}\Varid{prop\char95 Algae}\;\Varid{x}\mathrel{=}(\Varid{x}\geq \mathrm{0}\mathrel{\wedge}\Varid{x}\mathbin{<}\mathrm{20})\mathbin{==>}(\Varid{a}\;\Varid{x})\equiv (\Varid{b}\;\Varid{x}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{a}\mathrel{=}{}\<[15]%
\>[15]{}\length \comp \Varid{showAlgae}\comp \Varid{generateAlgae}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{b}\mathrel{=}{}\<[14]%
\>[14]{}\Varid{fromInteger}\comp \Varid{fib}\comp \succ {}\<[38]%
\>[38]{}\comp \Varid{toInteger}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
